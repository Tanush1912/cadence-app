        ...
        <div className="flex items-center gap-2">
          {onToggleMinimumMode && (
            <button
              ...
              className={cn(
                "w-9 h-9 rounded-full flex items-center justify-center text-[10px] font-bold tracking-wide transition-all",
                minimumMode
          ...
          {onSearch && (
            <button
              onClick={onSearch}
              className="w-9 h-9 rounded-full bg-[#1a1a1a] flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
            >
